...
- Outbox وJobs وWebhook idempotency وAudit وError IDs وControlled CSV/Print Invoice.
...
1. من الإدارة اضغط **تثبيت Demo Data**. هذا الإجراء منفصل ومؤشر بـ`is_demo`.
2. بدور Sales Agent: افتح CRM، أنشئ Lead ثم Customer ثم Invoice. السعر النهائي يأتي من Price Book.
...
8. من Delivery أنشئ Route وعيّن Rider. Rider يرى مساره فقط ويسجل Arrived ثم Delivered.
