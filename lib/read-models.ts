...
export const readModels = {
  ...
  sales_agent_dashboard: { view: "eco_sales_agent_dashboard_v", permission: "dashboard.sales.own", scope: "employee", defaultOrder: "period_start" },
  sales_manager_dashboard: { view: "eco_sales_manager_dashboard_v", permission: "dashboard.sales.team", scope: "team", defaultOrder: "period_start" },
  crm_leads: { view: "eco_crm_leads_v", permission: "crm.read", scope: "employee", searchColumn: "search_text", defaultOrder: "created_at" },
  customer_directory: { view: "eco_customer_directory_v", permission: "customers.read", scope: "employee", searchColumn: "search_text", defaultOrder: "created_at" },
  customer_export: { view: "eco_customer_export_v", permission: "exports.create", scope: "employee", searchColumn: "search_text", defaultOrder: "created_at" },
  ...
  cancellation_queue: { view: "eco_cancellation_queue_v", permission: "payments.verify", defaultOrder: "created_at" },
  ...
  delivery_export: { view: "eco_delivery_export_v", permission: "exports.create", defaultOrder: "route_date" },
