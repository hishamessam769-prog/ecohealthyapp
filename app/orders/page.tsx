          ...
          commands={[
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  required: true,
                  options: [
                    { value: "CATALOG", label: "باكدج من قائمة الأسعار" },
                    { value: "CUSTOM", label: "اشتراك / طلب خاص" },
                  ],
                },
                {
                  name: "package_version_id",
                  label: "الباكدج (عند اختيار قائمة الأسعار)",
                  type: "select",
                  lookup: "package_options",
                },
                { name: "custom_description", label: "اسم الاشتراك الخاص", placeholder: "مثال: اشتراك خاص باسم العميل" },
                { name: "custom_price", label: "السعر الخاص", type: "number" },
                { name: "custom_service_days", label: "عدد أيام الاشتراك الخاص", type: "number" },
                { name: "custom_package_type", label: "نوع الاشتراك الخاص", type: "select", options: [{ value: "LUNCH_ONLY", label: "Lunch Only" }, { value: "AM", label: "AM Package" }, { value: "BM", label: "BM Package" }, { value: "FULL_DAY", label: "Full Day" }] },
                { name: "discount_percentage", label: "نسبة الخصم %", type: "number", defaultValue: "0" },
                {
                  name: "start_date",
                ...
                { name: "payment_date", label: "تاريخ الدفع", type: "date", required: true },
